...
export const config = {
  ...
  supabase: {
    ...
    anonKey: process.env.SUPABASE_ANON_KEY || 'sb_publishable_jcR4C-0t6ibdL5010_bLMg_-0xxL61F',
  },
...
export const envVarDefinitions = {
  ...
  optional: {
    ...
    LOG_LEVEL: 'Logging level: debug, info, warn, error (default: info in prod)',
