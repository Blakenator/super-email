...
type Documents = {
    ...
    "\n  query GetSendProfiles {\n    getSendProfiles {\n      id\n      name\n      email\n      alias\n      type\n      isDefault\n    }\n  }\n": typeof types.GetSendProfilesDocument,
    ...
    "\n  mutation CompleteSetupWizard {\n    completeSetupWizard {\n      id\n      setupWizardCompletedAt\n    }\n  }\n": typeof types.CompleteSetupWizardDocument,
...
const documents: Documents = {
    ...
    "\n  mutation TestImapConnection($input: TestImapConnectionInput!) {\n    testImapConnection(input: $input) {\n      success\n      message\n    }\n  }\n": types.TestImapConnectionDocument,
    "\n  query GetSendProfilesFull {\n    getSendProfiles {\n      id\n      name\n      email\n      alias\n      type\n      isDefault\n      providerId\n      authMethod\n      emailAccountId\n      emailAccount {\n        id\n        name\n        email\n      }\n      smtpSettings {\n        id\n        host\n        port\n        useSsl\n      }\n    }\n  }\n": types.GetSendProfilesFullDocument,
    "\n  mutation CreateSendProfile($input: CreateSendProfileInput!) {\n    createSendProfile(input: $input) {\n      id\n      name\n      email\n      type\n    }\n  }\n": types.CreateSendProfileDocument,
    "\n  mutation DeleteSendProfile($id: String!) {\n    deleteSendProfile(id: $id)\n  }\n": types.DeleteSendProfileDocument,
    "\n  mutation UpdateSendProfile($input: UpdateSendProfileInput!) {\n    updateSendProfile(input: $input) {\n      id\n      name\n      email\n      alias\n      type\n      isDefault\n      smtpSettings {\n        id\n        host\n        port\n        useSsl\n      }\n    }\n  }\n": types.UpdateSendProfileDocument,
    ...
    "\n  query GetCustomDomains {\n    getCustomDomains {\n      id\n      domain\n      status\n      createdAt\n      dnsRecords {\n        id\n        recordType\n        purpose\n        name\n        value\n        isVerified\n      }\n      accounts {\n        id\n        localPart\n        emailAccount {\n          id\n          name\n          email\n        }\n        sendProfile {\n          id\n          name\n          email\n        }\n      }\n    }\n  }\n": types.GetCustomDomainsDocument,
    "\n  mutation AddCustomDomain($input: AddCustomDomainInput!) {\n    addCustomDomain(input: $input) {\n      id\n      domain\n      status\n    }\n  }\n": types.AddCustomDomainDocument,
    "\n  mutation VerifyCustomDomain($id: String!) {\n    verifyCustomDomain(id: $id) {\n      id\n      domain\n      status\n    }\n  }\n": types.VerifyCustomDomainDocument,
    "\n  mutation DeleteCustomDomain($id: String!) {\n    deleteCustomDomain(id: $id)\n  }\n": types.DeleteCustomDomainDocument,
    "\n  mutation CreateCustomDomainAccount($input: CreateCustomDomainAccountInput!) {\n    createCustomDomainAccount(input: $input) {\n      id\n      localPart\n      emailAccount {\n        id\n        email\n      }\n    }\n  }\n": types.CreateCustomDomainAccountDocument,
    "\n  mutation DeleteCustomDomainAccount($id: String!) {\n    deleteCustomDomainAccount(id: $id)\n  }\n": types.DeleteCustomDomainAccountDocument,
    ...
    "\n  mutation CompleteSetupWizard {\n    completeSetupWizard {\n      id\n      setupWizardCompletedAt\n    }\n  }\n": types.CompleteSetupWizardDocument,
