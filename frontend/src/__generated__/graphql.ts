...
export type GetEmailAccountsQuery = { __typename?: 'Query', getEmailAccounts: Array<{ __typename?: 'EmailAccount', id: string, name: string, email: string, host: string, port: number, accountType: EmailAccountType, useSsl: boolean, lastSyncedAt?: string | null, isSyncing: boolean, syncProgress?: number | null, syncStatus?: string | null, isHistoricalSyncing: boolean, historicalSyncProgress?: number | null, historicalSyncStatus?: string | null, historicalSyncLastAt?: string | null, isUpdateSyncing: boolean, updateSyncProgress?: number | null, updateSyncStatus?: string | null, updateSyncLastAt?: string | null, defaultSmtpProfileId?: string | null, providerId?: string | null, isDefault: boolean, defaultSmtpProfile?: { __typename?: 'SmtpProfile', id: string, name: string, email: string } | null }> };
