...
export type FetchProfileQuery = { __typename?: 'Query', fetchProfile?: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string, themePreference: ThemePreference, navbarCollapsed: boolean, notificationDetailLevel: NotificationDetailLevel, inboxDensity: boolean, inboxGroupByDate: boolean, blockExternalImages: boolean } | null };
