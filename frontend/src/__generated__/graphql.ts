...
export type Mutation = {
   ...
   * Syncs with Stripe first. If the Stripe subscription is still active, trialing, or past due,
   * updates line items in place and/or clears a scheduled cancellation (cancel_at_period_end);
   * returns null when no redirect is needed.
   * If the subscription has fully ended or there is no usable Stripe subscription, creates a
   * new Stripe Checkout session and returns its URL.
   * Requires Stripe to be configured on the server.
   */
...
export type MailboxUpdatesSubscription = { __typename?: 'Subscription', mailboxUpdates: { __typename?: 'MailboxUpdate', type: MailboxUpdateType, emailAccountId: string, message?: string | null, emails?: Array<{ __typename?: 'Email', id: string, messageId: string, folder: EmailFolder, fromAddress: string, fromName?: string | null, subject: string, receivedAt: string, isRead: boolean, isStarred: boolean, emailAccountId: string, toAddresses: Array<string>, ccAddresses?: Array<string> | null, bccAddresses?: Array<string> | null, threadId?: string | null, threadCount?: number | null, tags: Array<{ __typename?: 'Tag', id: string, name: string, color: string }> }> | null } };

export type FetchProfileQueryVariables = Exact<{ [key: string]: never; }>;


export type FetchProfileQuery = { __typename?: 'Query', fetchProfile?: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string, themePreference: ThemePreference, navbarCollapsed: boolean, notificationDetailLevel: NotificationDetailLevel, inboxDensity: boolean, inboxGroupByDate: boolean, blockExternalImages: boolean, setupWizardCompletedAt?: string | null } | null };
...
export type GetEmailsByThreadQuery = { __typename?: 'Query', getEmailsByThread: Array<{ __typename?: 'Email', id: string, messageId: string, folder: EmailFolder, fromAddress: string, fromName?: string | null, toAddresses: Array<string>, ccAddresses?: Array<string> | null, bccAddresses?: Array<string> | null, subject: string, textBody?: string | null, htmlBody?: string | null, bodyPreview?: string | null, receivedAt: string, isRead: boolean, isStarred: boolean, emailAccountId: string, hasAttachments: boolean, attachmentCount: number, inReplyTo?: string | null, threadId?: string | null, attachments: Array<{ __typename?: 'Attachment', id: string, filename: string, mimeType: string, extension?: string | null, size: number, attachmentType: AttachmentType, contentId?: string | null, isSafe: boolean }> }> };
...
export type GetStarredEmailsQuery = { __typename?: 'Query', getEmails: Array<{ __typename?: 'Email', id: string, messageId: string, folder: EmailFolder, fromAddress: string, fromName?: string | null, toAddresses: Array<string>, subject: string, bodyPreview?: string | null, receivedAt: string, isRead: boolean, isStarred: boolean, emailAccountId: string }> };
...
export type HealthCheckQuery = { __typename?: 'Query', healthCheck: { __typename?: 'HealthInfo', status: string, version: string, timestamp: string, uptimeSeconds: number } };

export type GetEmailAccountsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetEmailAccountsQuery = { __typename?: 'Query', getEmailAccounts: Array<{ __typename?: 'EmailAccount', id: string, name: string, email: string, type: EmailAccountType, defaultSendProfileId?: string | null, providerId?: string | null, isDefault: boolean, authMethod: AuthMethod, needsReauth: boolean, defaultSendProfile?: { __typename?: 'SendProfile', id: string, name: string, email: string } | null, imapSettings?: { __typename?: 'ImapAccountSettings', id: string, host: string, port: number, accountType: ImapAccountType, useSsl: boolean, lastSyncedAt?: string | null, isHistoricalSyncing: boolean, historicalSyncProgress?: number | null, historicalSyncStatus?: string | null, historicalSyncLastAt?: string | null, isUpdateSyncing: boolean, updateSyncProgress?: number | null, updateSyncStatus?: string | null } | null }> };
...
export type GetSendProfilesFullQuery = { __typename?: 'Query', getSendProfiles: Array<{ __typename?: 'SendProfile', id: string, name: string, email: string, alias?: string | null, type: SendProfileType, isDefault: boolean, providerId?: string | null, authMethod: AuthMethod, emailAccountId?: string | null, emailAccount?: { __typename?: 'EmailAccount', id: string, name: string, email: string } | null, smtpSettings?: { __typename?: 'SmtpAccountSettings', id: string, host: string, port: number, useSsl: boolean } | null }> };
...
export type CompleteSetupWizardMutationVariables = Exact<{ [key: string]: never; }>;


export type CompleteSetupWizardMutation = { __typename?: 'Mutation', completeSetupWizard: { __typename?: 'User', id: string, setupWizardCompletedAt?: string | null } };
...
export type GetEmailsForTriageQuery = { __typename?: 'Query', getEmails: Array<{ __typename?: 'Email', id: string, messageId: string, folder: EmailFolder, fromAddress: string, fromName?: string | null, toAddresses: Array<string>, subject: string, bodyPreview?: string | null, receivedAt: string, isRead: boolean, isStarred: boolean, emailAccountId: string, tags: Array<{ __typename?: 'Tag', id: string, name: string, color: string }> }> };
...
export const CompleteSetupWizardDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CompleteSetupWizard"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"completeSetupWizard"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"setupWizardCompletedAt"}}]}}]}}]} as unknown as DocumentNode<CompleteSetupWizardMutation, CompleteSetupWizardMutationVariables>;
